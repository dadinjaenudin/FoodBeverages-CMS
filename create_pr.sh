...
REPO_OWNER="dadinjaenudin"
REPO_NAME="FoodBeverages-CMS"
BASE_BRANCH="main"
HEAD_BRANCH="genspark_ai_developer"

# PR Details
PR_TITLE="feat: Complete F&B HO System - Phase 9 (14 CRUD Modules + UI + Documentation)"
PR_BODY="## 🎉 Complete F&B Head Office Management System - Phase 9
...
echo "gh pr create --base $BASE_BRANCH --head $HEAD_BRANCH --title \"$PR_TITLE\" --body \"$PR_BODY\""
